...
const char *WINDOWTITLE = { "Project #6: Keytime Animation -- Kevin Neiger" };
...
void AddKeyframe(float time, float _x, float _y, float _z, float thetaX, float thetaY, float thetaZ) {
	Xpos.AddTimeValue(time, _x);
	Ypos.AddTimeValue(time, _y);
	Zpos.AddTimeValue(time, _z);
	ThetaX.AddTimeValue(time, thetaX);
	ThetaY.AddTimeValue(time, thetaY);
	ThetaZ.AddTimeValue(time, thetaZ);
}
...
InitGraphics( void )
{
	...
	Xpos.AddTimeValue(   10.f,  800.f );
	Ypos.AddTimeValue(    0.f,    0.f );
	Ypos.AddTimeValue(   10.f,  500.f );
	Zpos.AddTimeValue(    0.f,    0.f );
	Zpos.AddTimeValue(   10.f, 1200.f );
	ThetaX.AddTimeValue(  0.f,    0.f );
	ThetaX.AddTimeValue( 10.f,   90.f );
	ThetaY.AddTimeValue(  0.f,    0.f );
	ThetaY.AddTimeValue( 10.f,  180.f );
	ThetaZ.AddTimeValue(  0.f,    0.f );
	ThetaZ.AddTimeValue( 10.f,  720.f );
	*/

	AddKeyframe(0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f);
	AddKeyframe(2.f, 40.f, 800.f, 400.f, -180.f, 450.f, 360.f);
	AddKeyframe(3.f, 100.f, 600.f, 600.f, 45.f, 90.f, 400.f);
	AddKeyframe(6.f, 900.f, 800.f, 200.f, 350.f, 20.f, 0.f);
	AddKeyframe(9.f, 700.f, 400.f, 1300.f, 60.f, 200.f, 660.f);
	AddKeyframe(10.f, 800.f, 500.f, 1200.f, 90.f, 180.f, 720.f);
...
InitLists( void )
{
	...
	float t = 0.;
	{;
		float xpos = Xpos.GetValue( t);
		float ypos = Ypos.GetValue( t);
		float zpos = Zpos.GetValue( t);
		float ax = ThetaX.GetValue( t);
		float ay = ThetaY.GetValue( t);
		float az = ThetaZ.GetValue( t);
		glPushMatrix( );
			glTranslatef( xpos, ypos, zpos );
			glRotatef( ax,  1., 0., 0. );
			glRotatef( ay,  0., 1., 0. );
	...
	{
		float xpos = Xpos.GetValue(10.);
		float ypos = Ypos.GetValue(10.);
		float zpos = Zpos.GetValue(10.);
		float ax = ThetaX.GetValue(10.);
		float ay = ThetaY.GetValue(10.);
		float az = ThetaZ.GetValue(10.);
		glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glRotatef(ax, 1., 0., 0.);
			glRotatef(ay, 0., 1., 0.);
